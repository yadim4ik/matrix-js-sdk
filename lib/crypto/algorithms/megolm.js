...
MegolmDecryption.prototype._requestKeysForEvent = function(event, firstKnownIndex) {
    ...
    this._sendKeyRequestEvent(senderKey, sessionId, firstKnownIndex, false);
};
...
MegolmDecryption.prototype.onRoomKeyEvent = function(event) {
    ...
    this._sendKeyRequestEvent(senderKey, sessionId, null, true);
...
MegolmDecryption.prototype._sendKeyRequestEvent = function(
    senderKey, sessionId, firstKnownIndex, fulfilled
) {
    ...
    if (firstKnownIndex !== null) {
        content.first_known_index = firstKnownIndex;
    }

    if (fulfilled) {
        content.fulfilled = true;
    }

    this._crypto.sendKeyRequestEvent(this._roomId, content);
};
