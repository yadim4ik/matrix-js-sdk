 ...
 * @alias module:crypto
 *
 * @param {module:client~MatrixClient} client Matrix Client
 *
 ...
 */
function Crypto(client, sessionStore, userId, deviceId) {
    this._client = client;
    ...
    _registerEventHandlers(this, client);
...
function _uploadDeviceKeys(crypto) {
    ...
    return crypto._client.uploadKeysRequest({
...
Crypto.prototype.downloadKeys = function(userIds, forceDownload) {
    ...
    return this._client.downloadKeysForUsers(
        downloadUsers
    ).then(function(res) {
...
Crypto.prototype.ensureOlmSessionsForUsers = function(users) {
    ...
    return this._client.claimOneTimeKeys(
...
Crypto.prototype.sendKeyRequestEvent = function(roomId, content) {
    // TODO: resends
    this._client.sendMessageEventRaw(roomId, "m.room.key_request", content).done();
};
