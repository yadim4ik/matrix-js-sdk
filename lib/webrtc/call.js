...
MatrixCall.prototype._gotLocalOffer = function(description) {
    ...
    self.peerConn.setLocalDescription(description);
};
...
MatrixCall.prototype._onIceConnectionStateChanged = function() {
    ...
    } else if (this.state == 'connected' && this.peerConn.iceConnectionState == 'failed') {
        // it told us it was working and now it's saying it failed, ignore it
        return;
    }
    debuglog(
